-- ============================================================
-- Migration: Fix Group Tours Financial Summary View
-- Replaces fr.status = 'paid' with fr.status = 'confirmed'
-- ============================================================
...
LEFT JOIN (
  ...
  WHERE fr.type = 'income' AND fr.status = 'confirmed' AND t.group_tour_id IS NOT NULL
