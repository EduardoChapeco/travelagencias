...
async function main() {
  const connectionString = "postgresql://postgres:EEaR6399!%40%232026@db.esmppoxxnyiscidzsjvy.supabase.co:5432/postgres";
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, '../supabase/migrations/20260722000000_flight_reaccommodation_workflow.sql');
