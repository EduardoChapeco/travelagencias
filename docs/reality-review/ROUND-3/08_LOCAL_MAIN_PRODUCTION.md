# Sincronização Local, Main e Produção — Rodada 3 (Turis)
...
- **Hosting**: O frontend e o backend serverless do Turis estão configurados para deploy no Cloudflare Pages.
