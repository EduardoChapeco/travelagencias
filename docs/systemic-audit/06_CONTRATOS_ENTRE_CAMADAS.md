...
1. **`m.checkin.$token.tsx`:**
   ...
   * *Raciocínio Técnico:* Utilizado para chamar RPCs seguras (`SECURITY DEFINER`) criadas sob demanda na Fase 7 que contornam o isolamento padrão RLS para clientes anônimos acessando o portal móvel.
