...
* **MOCK / SIMULADO (Apenas front ou dados estáticos, sem conexões reais no banco):** **0** *(Nota: Todos os mocks de banco foram resolvidos com as migrações recentes do repositório).*
