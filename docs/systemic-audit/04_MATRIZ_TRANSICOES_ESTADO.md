...
| *Qualquer um* | `perdido` | Negociação cancelada pelo cliente ou inatividade. | Agente / Admin | Sem restrições. |
...
| `aceita` | *Qualquer outro*| **BLOQUEIO DE SEGURANÇA:** Propostas aceitas e convertidas são congeladas. | Nenhum | **Transição inválida:** Proposta aceita não pode voltar para rascunho ou recusada. |
...
| `assinado` | *Qualquer outro*| **CONGELAMENTO:** Contratos assinados não podem ser editados ou cancelados. | Nenhum | **Bloqueado:** Exige geração de adendo para qualquer alteração posterior. |
...
| `archived` | *Qualquer outro*| Itinerário no histórico não pode voltar a ser ativo. | Nenhum | **Bloqueado:** Protege o histórico de bilhetes emitidos. |
