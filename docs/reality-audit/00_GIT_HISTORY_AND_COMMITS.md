...
4. **`b68316e`**: *style: restore original expandable sidebar, apply responsiveness fixes, and optimize layouts*
   - Escopo: Restauração/refatoração de estilos do sidebar principal.
5. **`16aa64b`**: *fix: upgrade Gemini API endpoint to v1 and migrate to gemini-2.5-flash...*
...
6. **`8d5033e`**: *refactor: P0/P1/P2/P3 stabilization - security, OCR, gmail-sync, rooming, brand kit, dynamic imports*
