...
* **Sombras na UI:** Vários componentes e páginas usam classes de sombras (`shadow-sm`, `shadow-xl`, `shadow-md`, etc.) desrespeitando as diretrizes estritas de design plano *Light Editorial SaaS* (que proíbe sombras).
