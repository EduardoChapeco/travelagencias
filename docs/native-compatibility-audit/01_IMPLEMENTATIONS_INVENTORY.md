...
- **[types.ts](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/integrations/supabase/types.ts)**:
  - **Função**: Contém tipos gerados do banco de dados. Foi modificado para incluir definições parciais das tabelas de cotação.
  - **Linhas**: ~9.000 linhas.
- **[package.json](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/package.json)**:
  - **Função**: Manifesto de dependências. Adicionado `pg` v8.22.0.
- **[routeTree.gen.ts](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/routeTree.gen.ts)**:
  - **Função**: Mapeamento estático de rotas do TanStack Router.

### 1.2. Novos Arquivos Adicionados (Não Rastreados)

- **[quotes.tsx](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/routes/agency.$slug.quotes.tsx)**:
  - **Função**: Layout principal da rota `/agency/$slug/quotes` que envelopa as telas do módulo.
  - **Tamanho**: 211 bytes, 10 linhas.
- **[quotes.index.tsx](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/routes/agency.$slug.quotes.index.tsx)**:
...
- **[quotes.$id.tsx](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/routes/agency.$slug.quotes.$id.tsx)**:
...
- **[quotes.ts (service)](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/services/quotes.ts)**:
...
- **[quotes-rag.ts (service)](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/services/quotes-rag.ts)**:
...
- **[quotes-scoring.ts (service)](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/services/quotes-scoring.ts)**:
...
- **[quotes-simulation.ts (service)](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/services/quotes-simulation.ts)**:
...
- **[quotes.ts (types)](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/src/types/quotes.ts)**:
...
- **[20260726000000_vibetour_quote_tables.sql](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/supabase/migrations/20260726000000_vibetour_quote_tables.sql)**:
  - **Função**: Criação das tabelas de cotação core, relacionamentos e RLS padrão.
- **[20260727000000_vibetour_global_rules_security.sql](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/supabase/migrations/20260727000000_vibetour_global_rules_security.sql)**:
...
- **[20260728000000_vibetour_memory_rag_tables.sql](file:///c:/Users/Excelência Tour SMO/.gemini/antigravity-ide/scratch/travelagencias/supabase/migrations/20260728000000_vibetour_memory_rag_tables.sql)**:
