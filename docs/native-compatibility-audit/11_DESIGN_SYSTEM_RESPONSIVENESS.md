...
* **Pontos de Quebra Encontrados**:
  1. **Matriz de Persona (Tabela)**: Em telas com largura inferior a 400px, a tabela de comparação horizontal das personas e alternativas sofre estouro horizontal (*overflow*), exigindo scroll na página inteira ao invés de scroll interno no container do card.
