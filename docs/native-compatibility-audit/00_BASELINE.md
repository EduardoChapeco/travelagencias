...
A análise do diretório de trabalho local revela alterações não rastreadas (*untracked*) e modificadas (*modified*) que afetam diretamente o Motor de Cotações VibeTour:
