...
* **Commits Locais Relevantes adicionados**:
  - `2ac19cc` - *fix(rooming-list): resolve typecheck errors and align with database schema*
  - `60240f4` - *fix: add deploy scripts with NODE_OPTIONS 8GB heap for Nitro SSR build*
  - `c594808` - *feat: dual-column contextual sidebar navigation...*
