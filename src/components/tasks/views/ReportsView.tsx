  ...
  return (
    <div className="bg-[var(--surface)] rounded-2xl border p-4 md:p-6 flex flex-col h-full space-y-6 overflow-y-auto no-scrollbar">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 shrink-0">
        <div className="p-4 rounded-xl border border-border bg-surface-alt/10 space-y-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-[350px]">
        ...
        <div className="p-5 border border-border rounded-xl flex flex-col bg-surface">
        ...
        <div className="p-5 border border-border rounded-xl flex flex-col bg-surface col-span-1 lg:col-span-2">
