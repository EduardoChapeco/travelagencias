          ...
          <div className="px-6 py-6 space-y-5">
            ...
            <div className="rounded-xl border border-border p-4 bg-surface-alt/20 space-y-4">
              ...
              <Field label="Nacionalidade Emissora">
                <Input value={nationality} onChange={(e) => setNationality(e.target.value)} placeholder="Ex: Brasileiro" />
              </Field>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <Field label="Email (Opcional)">
                <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="passageiro@email.com" />
              </Field>
            ...
            <label className="flex items-center gap-3 rounded-xl border border-brand/20 bg-brand/5 p-4 cursor-pointer hover:border-brand/40 transition-colors">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted-foreground">Responsável financeiro ou líder da reserva no destino.</span>
              </div>
            </label>
          </div>
