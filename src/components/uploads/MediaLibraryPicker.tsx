        ...
        <div className="flex-1 overflow-y-auto p-6 bg-surface-alt/20">
          {isLoading ? (
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
              <label className="relative flex aspect-square cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-border hover:border-brand/50 hover:bg-surface-alt transition-colors">
                <input
                  type="file"
                  accept="image/*"
                  className="hidden"
              ...
              {files?.map((f) => {
                ...
                return (
                  <div
                    ...
                    className="group relative aspect-square overflow-hidden rounded-xl border border-border bg-surface cursor-pointer hover:ring-2 ring-brand transition-all"
                  >
