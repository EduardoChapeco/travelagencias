    ...
    <div className="flex flex-col w-full font-sans bg-slate-900 text-slate-100">
      ...
      <div className="relative w-full h-[794px] break-inside-avoid">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-[40px] p-16 text-center max-w-4xl w-full">
            <div className="text-sm font-bold uppercase tracking-[0.3em] text-white/70 mb-4">
              Aventura Exclusiva
            </div>
            <h1
              className="text-[120px] leading-none mb-6 text-white"
              ...
              <div key={i} className="relative pl-12 pb-16 last:pb-0 break-inside-avoid">
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8">
                  <div className="flex items-center gap-4 mb-4">
                    <span
                      className="px-4 py-1.5 rounded-lg text-xs font-bold uppercase text-white"
                      style={{ backgroundColor: brand }}
                    >
                      {d.day || `Dia ${i + 1}`}
                    </span>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {p.hotels!.map((h, i) => (
                    <div
                      key={i}
                      className="bg-white border border-slate-200 rounded-2xl p-6 break-inside-avoid"
                    >
      ...
      <div className="bg-[#1E293B] px-24 py-32 text-center relative overflow-hidden break-inside-avoid">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div
            className="text-[120px] leading-none mb-12"
            style={{
              fontFamily: "'Bebas Neue', cursive",
              color: brand === "#1e293b" ? "#38bdf8" : brand,
            }}
          >
          ...
          <div className="grid grid-cols-2 gap-8 text-left">
            ...
            <div
              className="bg-white rounded-3xl p-8 text-slate-900 border-4"
              style={{ borderColor: brand === "#1e293b" ? "#38bdf8" : brand }}
            >
              <div className="flex justify-between items-start mb-4">
                <div className="text-xs uppercase tracking-widest text-slate-500 font-bold">
                  À vista (PIX)
                </div>
                <div className="bg-emerald-100 text-emerald-700 px-3 py-1 rounded text-xs font-bold">
                  -{vm.totals.descontoPixPercentual}%
                </div>
              </div>
              <div className="text-4xl font-bold">{money(vm.totals.totalPix, p.currency)}</div>
            </div>
          </div>
        </div>
      </div>
