      ...
      return (
        <section className="relative overflow-hidden rounded-3xl bg-surface">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center p-16 text-center lg:p-32 bg-gradient-to-t from-surface/80 via-transparent to-transparent">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg lg:text-xl text-muted-foreground font-medium drop-shadow-sm">
              {b.subtitle}
            </p>
              ...
              <div className="mt-10">
                {b.cta_link.startsWith("http") ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex h-14 items-center justify-center rounded-full bg-brand px-8 text-sm font-bold text-brand-foreground transition-all hover:scale-105 hover:shadow-xl hover:shadow-brand/20"
                  >
                    {b.cta_label}
                  </a>
                ) : (
          ...
          {b.image_url && (
            <div className="flex-1 w-full max-w-lg">
              <img
                src={b.image_url}
                alt="Content"
                className="rounded-2xl object-cover shadow-xl aspect-square lg:aspect-[4/3] w-full"
              />
            </div>
          )}
        </section>
    ...
    case "contact":
      return (
        <section className="mx-auto max-w-4xl text-center bg-surface-alt/50 border border-border/50 rounded-3xl p-12 lg:p-16">
          ...
          <a
            href={`/p/${agencySlug}`}
            className="inline-flex h-12 items-center justify-center rounded-full bg-foreground px-8 text-sm font-bold text-background transition-colors hover:bg-foreground/90"
          >
            Falar com a agência
          </a>
        </section>
