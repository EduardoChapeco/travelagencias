...
export const BLOCK_DEFAULTS: {
  ...
  features: {
    ...
    items: [
      { icon: "✈️", title: "Destinos exclusivos", description: "Acesso a destinos nacionais e internacionais com preços especiais." },
      { icon: "🛡️", title: "Segurança total", description: "Viaje com tranquilidade com suporte 24h e seguro viagem incluso." },
      { icon: "💼", title: "Atendimento personalizado", description: "Um consultor dedicado para cada cliente." },
    ],
  },
  cta: {
    type: "cta",
  ...
  faq: {
    ...
    items: [
      { question: "Como faço para solicitar um orçamento?", answer: "Entre em contato pelo WhatsApp ou formulário e um consultor retornará em até 2 horas." },
      { question: "Vocês trabalham com seguro viagem?", answer: "Sim! Trabalhamos com as melhores seguradoras do mercado." },
    ],
  },
  testimonials: {
    type: "testimonials",
    ...
    items: [
      { author: "Maria Silva", role: "Cliente há 3 anos", text: "A melhor experiência de viagem que já tive! O atendimento é impecável.", avatar_url: "", stars: 5 },
      { author: "João Santos", role: "Viagem em família", text: "Organizaram tudo com perfeição. Recomendo muito!", avatar_url: "", stars: 5 },
    ],
  },
  tours_grid: {
    type: "tours_grid",
