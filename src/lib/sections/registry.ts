...
export const SECTION_REGISTRY: Record<string, SectionDefinition> = {
    ...
    fields: [
      {
        key: "image",
        type: "image_unsplash",
        label: "Imagem de Fundo (Unsplash keyword)",
        required: true,
        defaultValue: "travel paradise",
      },
      {
        key: "overlayOpacity",
        type: "number",
        label: "Opacidade do Overlay (0 a 1)",
        required: true,
        defaultValue: 0.5,
      },
      {
      ...
      },
      {
        ...
        required: true,
        defaultValue: "O destino dos seus sonhos está aqui",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Os melhores pacotes e suporte personalizado para sua viagem.",
      },
      {
        key: "cta1_text",
        type: "text",
      ...
      },
      {
        ...
        required: false,
        defaultValue: "Conhecer Roteiros",
      },
      {
        key: "cta2_url",
        type: "url",
  ...
  "hero-split": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Planeje sua próxima grande aventura",
      },
      {
        key: "paragraph",
        type: "text",
        ...
        required: true,
        defaultValue:
          "Roteiros elaborados por quem entende de viagem, com segurança e suporte completo.",
      },
      {
        key: "cta1_text",
        type: "text",
      ...
      },
      {
        ...
        required: true,
        defaultValue: "hotel room view",
      },
      {
        key: "imageSecondary",
        type: "image_unsplash",
        label: "Imagem Secundária (Opcional)",
        required: false,
      ...
      },
      {
        ...
        options: [
          { value: "rounded-none", label: "Sem borda" },
          { value: "rounded-lg", label: "Suave" },
          { value: "rounded-2xl", label: "Acentuado" },
  ...
  "hero-gradient": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Sua viagem completa na palma da mão",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Acompanhe seu roteiro, passagens e suporte da nossa agência em tempo real.",
      },
      {
        key: "cta1_text",
        type: "text",
  ...
  "hero-dark": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Experiências exclusivas e sob medida",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Roteiros privativos de alto padrão para os viajantes mais exigentes.",
      },
      {
        key: "cta_text",
        type: "text",
        label: "Botão Principal",
        required: false,
        defaultValue: "Solicitar Consultoria",
      },
      {
        key: "cta_url",
        type: "url",
  ...
  "hero-travel": {
    ...
    description:
      "Fullscreen com formulário integrado para pesquisar destinos, datas e passageiros.",
    category: "hero",
    thumbnail: "hero",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue: "adventure mountain travel",
      },
      {
        key: "overlayOpacity",
        type: "number",
      ...
      },
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Encontre sua próxima experiência",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Roteiros exclusivos, cruzeiros e resorts com tarifas especiais.",
      },
      {
        key: "searchBarVisible",
        type: "toggle",
        label: "Exibir Barra de Busca",
        required: true,
        defaultValue: true,
      },
      {
        ...
        type: "text",
        label: "Texto do Botão Buscar",
        required: true,
        defaultValue: "Pesquisar Viagens",
      },
      {
        key: "searchButtonActionUrl",
        type: "url",
        label: "URL de Ação do Botão",
        required: true,
        defaultValue: "#roteiros",
      },
    ],
  ...
  "hero-bento": {
    ...
    thumbnail: "hero",
    aiHint:
      "Excelente para agências modernas que querem expor fotos de destinos e números juntos no hero.",
    fields: [
      {
        key: "headline",
        type: "text",
        label: "Título",
        required: true,
        defaultValue: "Viagens inesquecíveis organizadas para você",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Escolha seu destino e nós cuidamos de toda a burocracia.",
      },
      {
        key: "ctaText",
        type: "text",
        label: "Botão Principal",
        required: false,
        defaultValue: "Falar com Consultor",
      },
      {
        key: "ctaUrl",
        type: "url",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue: "Viaje sem preocupações.",
      },
      {
        key: "accentWord",
        type: "text",
        label: "Palavra de Destaque (Brand Color)",
        required: false,
        defaultValue: "Com segurança.",
      },
      {
        key: "subtitle",
        type: "text",
        ...
        required: true,
        defaultValue:
          "Nossa agência de viagens cuida de cada detalhe da sua estadia, voo e passeios.",
      },
      {
        key: "cta1_text",
        type: "text",
    ...
    fields: [
      {
        ...
        required: false,
        defaultValue: "Nossas Recomendações",
      },
      {
        key: "sectionTitle",
        type: "text",
        ...
        required: true,
        defaultValue: "Destinos em Destaque",
      },
      {
        ...
        required: false,
        defaultValue: "Escolha o local ideal para sua próxima viagem com tarifas promocionais.",
      },
      {
        key: "columns",
        type: "select",
      ...
      },
      {
        key: "ctaText",
        type: "text",
        label: "Texto do Botão Geral",
        required: false,
        defaultValue: "Ver Todos os Destinos",
      },
      {
        key: "ctaUrl",
        type: "url",
        label: "Link do Botão Geral",
        required: false,
        defaultValue: "#todos",
      },
      {
  ...
  "destinations-carousel": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Roteiros Mais Procurados",
      },
      {
        key: "autoplay",
        type: "toggle",
        label: "Autoplay Ativo",
        required: true,
        defaultValue: true,
      },
      {
  ...
  "destinations-slider-film": {
    ...
    description:
      "Layout editorial com texto fixo à esquerda e 3 cards verticais altos em leque à direita.",
    category: "destinations",
    thumbnail: "destinations",
    ...
    fields: [
      {
        ...
        required: false,
        defaultValue: "Destinos de Destaque",
      },
      {
        key: "headline",
        type: "text",
        label: "Título Grande",
        required: true,
        defaultValue: "Lugares Históricos",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Explore destinos ricos em cultura, gastronomia e tradições seculares.",
      },
      {
        key: "ctaText",
        type: "text",
      ...
      },
      {
        key: "counterVisible",
        type: "toggle",
        label: "Exibir Contador numérico",
        required: true,
        defaultValue: true,
      },
      {
        key: "items",
        type: "list",
        label: "Cards de Viagem (Filmstrip)",
        required: true,
        defaultValue: [
          {
            image:
    ...
    fields: [
      {
        ...
        label: "Título da Seção",
        required: true,
        defaultValue: "Explore Nossos Destinos",
      },
      {
        key: "sectionDescription",
        type: "text",
        label: "Descrição",
        required: false,
        defaultValue: "As melhores escolhas de viagem avaliadas pela nossa equipe.",
      },
      {
        key: "items",
        type: "list",
        label: "Cards (Mín 3, Recomendado 5)",
        required: true,
        defaultValue: [
          {
            image:
            ...
            name: "França & Europa",
            details: "Destaque especial da temporada",
            link: "#contato",
          },
          {
            image:
          ...
          {
            image:
              "https://images.unsplash.com/photo-1520175480921-4edfa2983e0f?auto=format&fit=crop&w=400&q=80",
            name: "Roma",
            details: "História e cultura",
            link: "#contato",
          },
        ],
      },
  ...
  "package-cards": {
    ...
    description:
      "Cards estruturados de viagem com preço, tag de inclusões (aéreo, hotel, guia) e duração.",
    category: "destinations",
    thumbnail: "destinations",
    aiHint:
      "Use para vender pacotes comerciais de viagem que listam inclusões de serviços e preços.",
    fields: [
      {
        key: "sectionTitle",
        type: "text",
        label: "Título",
        required: true,
        defaultValue: "Pacotes de Viagem Recomendados",
      },
      {
        key: "sectionDescription",
        type: "text",
        label: "Descrição",
        required: false,
        defaultValue: "Viagens completas com passagens, hospedagem e passeios inclusos.",
      },
      {
        key: "columns",
        type: "select",
        ...
        defaultValue: [
          {
            image:
              "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600&q=80",
            badge: "Mais Vendido",
            title: "Europa Clássica Especial",
            inclusions: "Voo, Hotel, Guia",
            duration: "12 Dias / 10 Noites",
            priceOriginal: "R$ 12.990",
            priceCurrent: "R$ 9.990",
            link: "#contato",
          },
          {
            image:
            ...
            inclusions: "Voo, Hotel, Resort",
            duration: "7 Dias / 6 Noites",
            priceOriginal: "R$ 6.900",
            priceCurrent: "R$ 4.890",
            link: "#contato",
          },
          {
            image:
              "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&w=600&q=80",
            badge: "Roteiro Exclusivo",
            title: "Grécia Incrível & Atenas",
            inclusions: "Hotel, Guia, Passeios",
            duration: "9 Dias / 8 Noites",
            priceOriginal: "R$ 11.200",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue: "Promoções de Temporada",
      },
      {
        key: "discountText",
        type: "text",
        ...
        required: true,
        defaultValue: "Até 50% de Desconto",
      },
      {
        key: "promoDestination",
        type: "text",
        label: "Destino em Oferta",
        required: true,
        defaultValue: "Cruzeiros no Atlântico",
      },
      {
        key: "promoImage",
        type: "image_unsplash",
        ...
        required: true,
        defaultValue: "cruise ship atlantic ocean",
      },
      {
        key: "newsTitle",
        type: "text",
        ...
        required: true,
        defaultValue: "Quer receber alertas de preço?",
      },
    ],
    defaultConfig: {
    ...
    fields: [
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Nossos Diferenciais",
      },
      {
        key: "sectionDescription",
        type: "text",
        label: "Descrição",
        required: false,
        defaultValue: "Garantimos tranquilidade em cada etapa do seu roteiro.",
      },
      {
        key: "columns",
        type: "select",
      ...
      },
      {
        ...
        options: [
          ...
          { value: "tinted", label: "Fundo Suave" },
        ],
      },
      {
        key: "items",
        ...
        defaultValue: [
          {
            ...
            description:
              "Consultores experientes dedicados a planejar seu roteiro de ponta a ponta.",
          },
          {
            icon: "safe",
            title: "Suporte 24h em Viagem",
            description: "Atendimento de emergência em português para qualquer eventualidade.",
          },
          {
            icon: "care",
            title: "Parcerias Premium",
            description: "Tarifas negociadas e upgrades exclusivos nos melhores hotéis do mundo.",
          },
        ],
      },
    ],
      ...
      items: [
        {
          icon: "vip",
          title: "Consultoria Exclusiva",
          description: "Consultores experientes dedicados a planejar seu roteiro de ponta a ponta.",
        },
        {
          icon: "safe",
          title: "Suporte 24h em Viagem",
    ...
    fields: [
      {
        ...
        label: "Título Principal",
        required: true,
        defaultValue: "Como Cuidamos de Você",
      },
      {
        key: "items",
        type: "list",
        label: "Lista de Features (Recomendado 4)",
        required: true,
        defaultValue: [
          {
            icon: "vip",
            title: "Hotéis Selecionados",
            description: "Apenas hotéis inspecionados com alta pontuação de higiene e localização.",
          },
          {
            icon: "safe",
            title: "Seguro Viagem Completo",
            description:
              "Seguro incluso nos pacotes com cobertura para bagagens, cancelamento e despesas médicas.",
          },
          {
            icon: "care",
            title: "Roteiro 100% sob medida",
            description: "Fazemos tudo de acordo com suas preferências e ritmo.",
          },
          {
            icon: "world",
            title: "Guias Locais Credenciados",
            description:
              "Passeios acompanhados de profissionais credenciados que falam seu idioma.",
          },
        ],
      },
    ],
    defaultConfig: {
      ...
      items: [
        ...
        },
        {
          icon: "world",
          title: "Guias Locais Credenciados",
          description: "Passeios acompanhados de profissionais credenciados que falam seu idioma.",
        },
      ],
    },
    defaultStyles: { ...DEFAULT_STYLES },
  ...
  "features-numbered": {
    ...
    description:
      "Itens numerados (01, 02, 03) dispostos em formato editorial com opção de zebra layout (imagem alternada).",
    category: "content",
    thumbnail: "content",
    aiHint:
      "Ótimo para explicar um passo a passo (ex: Como funciona nosso processo de consultoria).",
    fields: [
      {
        key: "sectionTitle",
        type: "text",
        label: "Título",
        required: true,
        defaultValue: "Passo a Passo de Criação",
      },
      {
        key: "zebraLayout",
        type: "toggle",
        label: "Zebra Layout (Inverter Lados)",
        required: true,
        defaultValue: true,
      },
      {
        ...
        defaultValue: [
          {
            ...
            description: "Conversamos sobre suas expectativas, orçamento e datas preferidas.",
            image:
              "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=600&q=80",
          },
          {
            title: "Primeira Versão do Roteiro",
            description:
              "Apresentamos uma proposta digital detalhada com custos de aéreo, hotéis e passeios.",
            image:
              "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=600&q=80",
          },
          {
            title: "Ajustes e Emissões",
            description:
              "Após sua aprovação, emitimos os vouchers e preparamos seu kit de viagem digital.",
            image:
    ...
    fields: [
      {
        ...
        defaultValue: "brand",
        options: [
          { value: "brand", label: "Cor da Marca" },
  ...
  "brands-logos": {
    ...
    description:
      "Carrossel infinito (marquee) ou grid de logos de parceiros/hotéis/companhias aéreas.",
    category: "content",
    thumbnail: "content",
    ...
    fields: [
      {
        ...
        label: "Título",
        required: false,
        defaultValue: "Trabalhamos com as Melhores Marcas",
      },
      {
        key: "mode",
        type: "select",
        ...
        options: [
          { value: "marquee", label: "Carrossel Contínuo" },
          { value: "grid", label: "Grid Estático" },
        ],
      },
      {
        key: "gridColumns",
      ...
      },
      {
        ...
        defaultValue: [
          {
            logoUrl:
              "https://images.unsplash.com/photo-1560179707-f14e90ef3623?auto=format&fit=crop&w=150&h=80&q=80",
            altText: "Marca 1",
          },
          {
            logoUrl:
  ...
  "about-split": {
    ...
    description:
      "Foto com moldura decorativa de um lado e texto institucional com marcadores e botão do outro.",
    category: "content",
    thumbnail: "content",
    ...
    fields: [
      {
        ...
        label: "Foto do Sobre",
        required: true,
        defaultValue: "travel agent smiling desk",
      },
      {
        key: "sectionLabel",
        type: "text",
      ...
      },
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Especialistas em transformar sonhos em destinos reais",
      },
      {
        key: "paragraph1",
        type: "text",
        ...
        required: true,
        defaultValue:
          "Fundada por entusiastas do turismo, nossa agência conta com uma rede global de parceiros para oferecer experiências seguras e confortáveis.",
      },
      {
        key: "paragraph2",
        type: "text",
        ...
        required: false,
        defaultValue:
          "Trabalhamos focados em atendimento humanizado. Cada roteiro é único e adaptado ao seu gosto.",
      },
      {
        key: "bullets",
        type: "list",
        label: "Marcadores de Valores",
        required: false,
        defaultValue: [
      ...
      },
      {
        ...
        label: "Texto do Botão",
        required: false,
        defaultValue: "Falar com Diretor",
      },
      {
        key: "ctaUrl",
        type: "url",
  ...
  "service-accordion": {
    ...
    description:
      "Lista vertical de serviços com títulos clicáveis que expandem revelando a descrição.",
    category: "content",
    thumbnail: "content",
    ...
    fields: [
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Nossos Serviços Adicionais",
      },
      {
        key: "allowMultiple",
        type: "toggle",
        label: "Permitir abrir vários ao mesmo tempo",
        required: true,
        defaultValue: false,
      },
      {
        ...
        defaultValue: [
          {
            ...
            description: "Buscamos as melhores conexões e tarifas corporativas ou promocionais.",
            link: "#contato",
          },
          {
            icon: "hotel",
            title: "Hospedagem Selecionada",
            description: "Reservas nos melhores hotéis com early check-in e café da manhã incluso.",
            link: "#contato",
          },
          {
            icon: "safe",
            title: "Seguros e Vistos",
            description:
              "Providenciamos o seguro ideal e prestamos assessoria para emissão de vistos consulares.",
            link: "#contato",
          },
        ],
      },
  ...
  "service-cards": {
    ...
    description:
      'Grid de cards com ícone ou ilustração no topo, título, descrição e link "Saiba mais".',
    category: "content",
    thumbnail: "content",
    ...
    fields: [
      {
        ...
        label: "Título da Seção",
        required: true,
        defaultValue: "O Que Oferecemos",
      },
      {
        key: "theme",
        type: "select",
        label: "Tema dos Cards",
        required: true,
        defaultValue: "light",
        options: [
          { value: "light", label: "Fundo Claro" },
          { value: "dark", label: "Fundo Escuro" },
          { value: "colored", label: "Fundo da Marca" },
        ],
      },
      {
        key: "items",
        ...
        defaultValue: [
          {
            icon: "world",
            title: "Roteiros de Lua de Mel",
            description: "Destinos românticos organizados com mimos e experiências únicas.",
          },
          {
            icon: "union",
            title: "Viagens em Grupo",
            description: "Grupos exclusivos com guias saindo do Brasil acompanhando a viagem.",
          },
          {
            icon: "vip",
            title: "Turismo de Luxo",
            description: "Serviços VIP, traslados privativos e experiências exclusivas.",
          },
        ],
      },
    ],
    ...
    fields: [
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Dicas de Viagem do Nosso Blog",
      },
      { key: "limit", type: "number", label: "Limite de Posts", required: true, defaultValue: 3 },
      {
        key: "standalone",
        type: "toggle",
        label: "Modo Manual (Sem carregar do banco)",
        required: true,
        defaultValue: true,
      },
      {
        ...
        defaultValue: [
          {
            ...
            category: "Dicas",
            title: "O que levar na mala para a Europa no Inverno?",
            date: "15 Mai 2026",
            snippet:
              "Um checklist completo das peças essenciais e regras de bagagem das companhias aéreas.",
          },
          {
            image:
              "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=500&q=80",
            category: "Destinos",
            title: "As praias mais bonitas do Caribe",
            date: "10 Mai 2026",
            snippet:
              "Descubra praias intocadas e resorts que valem a visita na sua próxima ida ao Caribe.",
          },
        ],
      },
    ],
    ...
    fields: [
      {
        key: "sectionTitle",
        type: "text",
        label: "Nossos Especialistas",
        required: true,
        defaultValue: "Converse com Nossos Consultores",
      },
      {
        key: "items",
        type: "list",
        ...
        defaultValue: [
          {
            ...
            name: "Ana Souza",
            role: "Especialista em Europa",
            bio: "Mais de 10 anos planejando roteiros personalizados pela Europa.",
          ...
          },
          {
            ...
            name: "Roberto Lima",
            role: "Especialista em Cruzeiros",
            bio: "Conhece as melhores cabines e rotas de navios pelo mundo.",
            whatsapp: "5549999999999",
          },
        ],
      },
    ...
    fields: [
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Roteiro Dia a Dia",
      },
      {
        key: "items",
        type: "list",
        label: "Dias do Roteiro",
        required: true,
        defaultValue: [
          {
            time: "Dia 01",
            title: "Chegada e Check-in",
            description: "Recepção no aeroporto, traslado privativo até o hotel e noite livre.",
          },
          {
            time: "Dia 02",
            title: "City Tour Histórico",
            description: "Visita guiada pelos principais monumentos históricos com almoço incluso.",
          },
          {
            time: "Dia 03",
            title: "Dia de Aventura",
            description: "Passeio opcional de barco ou trilha pela região com guias locais.",
          },
        ],
      },
    ],
  ...
  "testimonial-single": {
    ...
    description:
      "Card centralizado exibindo aspas gigantes e as palavras de um cliente satisfeito.",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue:
          "A consultoria foi excelente. Pensaram em cada detalhe, desde o assento do avião até surpresas no quarto do hotel. Viajamos sem nenhuma preocupação.",
      },
      {
        key: "author",
        type: "text",
      ...
      },
      {
        ...
        required: false,
        defaultValue: "Viajou para Itália em 2026",
      },
      {
        key: "avatar",
        type: "image_unsplash",
    ...
    fields: [
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Relatos de Nossos Viajantes",
      },
      {
        key: "items",
        type: "list",
        ...
        defaultValue: [
          {
            text: "A melhor agência de viagens. O suporte via WhatsApp me salvou quando meu voo foi cancelado.",
            author: "Marina Silva",
            role: "Viajante frequente",
            stars: 5,
          },
          {
            text: "Tudo perfeito. Os hotéis sugeridos eram excelentes e muito bem localizados.",
    ...
    fields: [
      {
        ...
        label: "Título da Seção",
        required: true,
        defaultValue: "Quem viaja com a gente, recomenda",
      },
      {
        key: "items",
        type: "list",
        label: "Depoimentos (Recomendado 3 ou 6)",
        required: true,
        defaultValue: [
          {
            author: "Juliana Pires",
            role: "Casal · Viagem de Mel",
            text: "Nossa lua de mel em Santorini foi impecável. A agência organizou passeios incríveis e jantares privativos.",
            stars: 5,
            avatar: "",
          },
          {
            ...
            text: "Facilidade para alterar passagens e tarifas muito competitivas. Excelente serviço corporativo.",
            stars: 5,
            avatar: "",
          },
          {
            ...
            role: "Mãe de Família",
            text: "Viajamos com 3 crianças pequenas e a assessoria na escolha do resort all-inclusive fez toda a diferença.",
            stars: 5,
            avatar: "",
          },
        ],
    ...
    fields: [
      {
        key: "sectionTitle",
        type: "text",
        label: "O Que Dizem os Nossos Membros VIP",
        required: true,
        defaultValue: "Depoimentos de Alta Classe",
      },
      {
        key: "items",
        type: "list",
        label: "Depoimentos VIP",
        required: true,
        defaultValue: [
          {
            author: "Dr. Alberto Faria",
            role: "Membro Platinum",
            text: "O atendimento de concierge no aeroporto de Dubai foi excelente. Serviço premium indiscutível.",
            stars: 5,
          },
          {
            author: "Helena Werneck",
            role: "Membro Gold",
            text: "A melhor experiência em cruzeiro de luxo. Quarto com mordomo e tudo reservado.",
            stars: 5,
          },
        ],
      },
  ...
  "testimonial-featured": {
    ...
    description:
      "Card largo com foto retangular grande à esquerda e depoimento em aspas gigante à direita.",
    category: "testimonials",
    thumbnail: "testimonials",
    aiHint:
      "Ideal para um depoimento institucional detalhado com foto do cliente tirada em viagem.",
    fields: [
      {
        key: "image",
        type: "image_unsplash",
        label: "Foto do Cliente em Viagem",
        required: true,
        defaultValue: "couple traveling selfie",
      },
      {
        key: "text",
        type: "text",
        ...
        required: true,
        defaultValue:
          "Nossa viagem de férias para o Japão foi espetacular. A agência montou um guia passo-a-passo detalhado de trem, hotéis e restaurantes locais. Sem dúvida, superou todas as expectativas!",
      },
      {
        key: "author",
        type: "text",
        ...
        required: true,
        defaultValue: "Juliana & Marcos",
      },
      {
        key: "role",
        type: "text",
        label: "Cargo ou Destino",
        required: false,
        defaultValue: "Férias de Família em Tóquio",
      },
  ...
  "testimonial-speech-bubble": {
    ...
    description:
      "Balão de fala arredondado com o depoimento apontando para a foto do cliente abaixo.",
    category: "testimonials",
    thumbnail: "testimonials",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue:
          "Super prático! Fiquei com receio de comprar online, mas a agência me mandou os vouchers e deu todo o suporte que precisei.",
      },
      {
        key: "author",
        type: "text",
        label: "Nome",
        required: true,
        defaultValue: "Fernanda Oliveira",
      },
      {
        key: "role",
        type: "text",
        label: "Subtítulo",
        required: false,
        defaultValue: "Mochilão pela América do Sul",
      },
      {
        key: "avatar",
        type: "image_unsplash",
        label: "Foto",
        required: false,
        defaultValue: "woman smile portrait",
      },
    ],
    defaultConfig: {
    ...
    fields: [
      {
        ...
        label: "Título",
        required: false,
        defaultValue: "Nossas Viagens Recentes",
      },
      {
        key: "images",
        type: "list",
        label: "Imagens Masonry",
        required: true,
        defaultValue: [
          {
            url: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=500&q=80",
  ...
  "video-section": {
    ...
    thumbnail: "media",
    aiHint:
      "Use para apresentar vídeos institucionais de alta qualidade ou depoimentos de clientes.",
    fields: [
      {
        key: "sectionTitle",
        type: "text",
        label: "Título",
        required: false,
        defaultValue: "Assista Como Viajamos",
      },
      {
        key: "videoUrl",
        type: "url",
      ...
      },
      {
        ...
        required: false,
        defaultValue: "beach sunset background",
      },
    ],
    defaultConfig: {
  ...
  "photo-text-alternating": {
    ...
    description:
      "Conteúdo em zigue-zague com foto de um lado e texto de outro alternando nas linhas.",
    category: "media",
    thumbnail: "media",
    aiHint:
      "Use para descrever múltiplos pilares de atuação ou pacotes especiais de forma estruturada.",
    fields: [
      {
        key: "sectionTitle",
        type: "text",
        label: "Título Principal",
        required: false,
        defaultValue: "Nossas Linhas de Viagem",
      },
      {
        key: "blocks",
        type: "list",
        ...
        defaultValue: [
          {
            title: "Viagens Terrestres Nacionais",
            description:
              "Conheça o Brasil por terra em hotéis fazenda e resorts selecionados com toda a família.",
            image:
              "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=600&q=80",
          },
          {
            title: "Cruzeiros Internacionais",
            description:
              "Cruzeiros marítimos all-inclusive saindo dos principais portos nacionais e mundiais.",
            image:
              "https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&w=600&q=80",
          },
        ],
  ...
  "parallax-section": {
    ...
    thumbnail: "media",
    aiHint:
      "Insira no meio da página para quebrar o ritmo de leitura com um visual 3D surpreendente.",
    fields: [
      {
        key: "backgroundImage",
        type: "image_unsplash",
        label: "Foto de Fundo",
        required: true,
        defaultValue: "mountain lake peak landscape",
      },
      {
        key: "overlayOpacity",
        type: "number",
      ...
      },
      {
        ...
        label: "Badge",
        required: false,
        defaultValue: "Sinta a Liberdade",
      },
      {
        key: "headline",
        type: "text",
        label: "Título",
        required: true,
        defaultValue: "A natureza te chama para explorar",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: true,
        defaultValue: "Roteiros de ecoturismo e aventura com guias locais altamente treinados.",
      },
      {
        key: "ctaText",
        type: "text",
        label: "Botão de Ação",
        required: false,
        defaultValue: "Ver Roteiros Ecológicos",
      },
      {
        key: "ctaUrl",
        type: "url",
  ...
  "map-contact": {
    ...
    description:
      "Layout 50/50 com Google Maps interativo de um lado e informações de endereço/WhatsApp do outro.",
    category: "media",
    thumbnail: "media",
    ...
    fields: [
      {
        key: "mapEmbedUrl",
        type: "url",
        label: "Embed URL do Google Maps",
        required: true,
        defaultValue:
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3540.3235650177724!2d-52.6174621!3d-27.1002364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94e539b7ea577903%3A0xe54d92cd0e4088!2sChapec%C3%B3%20-%20SC!5e0!3m2!1spt-BR!2sbr!4v1700000000000",
      },
      {
        key: "phone",
        type: "text",
      ...
      },
      {
        ...
        label: "E-mail",
        required: false,
        defaultValue: "contato@agencia.com.br",
      },
      {
        key: "address",
        type: "text",
        label: "Endereço",
        required: true,
        defaultValue: "Avenida Getúlio Vargas, 1000 - Centro, Chapecó - SC",
      },
      {
        key: "hours",
        type: "text",
        ...
        required: false,
        defaultValue: "Segunda a Sexta: 08:30 às 18:00",
      },
      {
        key: "whatsapp",
        type: "text",
  ...
  "cta-banner": {
    ...
    description:
      "Faixa horizontal em brand color ou fundo gradiente contendo um botão de ação destacado.",
    category: "cta",
    thumbnail: "cta",
    ...
    fields: [
      {
        ...
        label: "Título",
        required: true,
        defaultValue: "Pronto para planejar sua viagem?",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: false,
        defaultValue: "Converse com um especialista agora e tire suas dúvidas.",
      },
      {
        key: "ctaText",
        type: "text",
        label: "Texto do Botão",
        required: true,
        defaultValue: "Iniciar Atendimento",
      },
      {
        key: "ctaUrl",
        type: "url",
  ...
  "cta-newsletter": {
    ...
    thumbnail: "cta",
    aiHint:
      "Perfeito para capturar leads que querem apenas receber promoções de turismo por e-mail.",
    fields: [
      {
        key: "title",
        type: "text",
        label: "Título",
        required: true,
        defaultValue: "Receba promoções por E-mail",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: false,
        defaultValue: "Sem spam, apenas alertas das melhores passagens e tarifas.",
      },
      {
        key: "placeholder",
        type: "text",
  ...
  "cta-contact-form": {
    ...
    description:
      "Formulário completo com campos (Nome, E-mail, Fone, Assunto, Mensagem) gravando direto no banco.",
    category: "cta",
    thumbnail: "cta",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue: "Solicite um Orçamento Personalizado",
      },
      {
        key: "subtitle",
        type: "text",
        label: "Subtítulo",
        required: false,
        defaultValue: "Deixe seus dados e um especialista entrará em contato em até 2 horas úteis.",
      },
      {
        key: "successMessage",
        type: "text",
        ...
        required: true,
        defaultValue: "Sua solicitação foi enviada! Em breve entraremos em contato.",
      },
    ],
    defaultConfig: {
  ...
  "cta-whatsapp-float": {
    ...
    thumbnail: "cta",
    aiHint:
      "Adicione no final da página para que o visitante possa falar diretamente pelo WhatsApp.",
    fields: [
      {
        key: "whatsapp",
        type: "text",
        label: "Número de WhatsApp (DDI + DDD + Número)",
        required: true,
        defaultValue: "5549999999999",
      },
      {
        ...
        required: true,
        defaultValue: "Olá, gostaria de solicitar um orçamento de viagem!",
      },
      {
        key: "tooltip",
        type: "text",
        label: "Texto do Tooltip / Alerta",
        required: false,
        defaultValue: "Fale conosco pelo WhatsApp",
      },
    ],
    defaultConfig: {
      whatsapp: "5549999999999",
  ...
  "search-bar-travel": {
    ...
    description:
      "Barra horizontal de busca rápida de viagens (Destino, datas, etc) posicionável isoladamente.",
    category: "cta",
    thumbnail: "cta",
  ...
  "nav-standard": {
    ...
    description:
      "Menu superior com logo à esquerda, links centralizados e botão de destaque à direita.",
    category: "navigation",
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue:
          "Sua agência de turismo de confiança. Realizando as melhores viagens em grupo e roteiros personalizados pelo mundo.",
      },
      {
        key: "phone",
        type: "text",
    ...
    fields: [
      {
        ...
        label: "Descrição da Empresa",
        required: true,
        defaultValue: "Experiências de luxo e passeios de aventura planejados sob medida.",
      },
      {
        key: "phone",
        type: "text",
      ...
      },
      {
        ...
        label: "E-mail",
        required: false,
        defaultValue: "viagens@agencia.com.br",
      },
    ],
    defaultConfig: {
    ...
    fields: [
      {
        ...
        required: true,
        defaultValue: "Inscreva-se e Receba Alertas",
      },
      {
        key: "ctaButtonText",
        type: "text",
      ...
      },
      {
        ...
        required: true,
        defaultValue: "Sua agência especialista em cruzeiros e roteiros terrestres.",
      },
    ],
    defaultConfig: {
  ...
  "footer-with-map": {
    ...
    thumbnail: "footer",
    aiHint:
      "Excelente para portais de agências que querem ter o mapa sempre acessível em qualquer página.",
    fields: [
      {
        key: "mapEmbedUrl",
        type: "url",
      ...
      },
      {
        ...
        label: "Descrição da Empresa",
        required: true,
        defaultValue: "Nossa equipe está de portas abertas para lhe atender.",
      },
    ],
    defaultConfig: {
      mapEmbedUrl:
