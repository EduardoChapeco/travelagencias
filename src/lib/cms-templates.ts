...
export const CMS_TEMPLATES: PageTemplate[] = [
  ...
  },
  {
    ...
    description: "Visual moderno e futurista com fundo escuro, contatos por WhatsApp estruturados e feed de blog.",
    category: "biolink",
    blocks: [
      {
        id: "glow-hdr",
      ...
      },
      {
        ...
        departments: [
          { name: "Consultor de Vendas", phone: "5549999999999", icon: "chat", message: "Olá! Gostaria de cotar um roteiro." },
          { name: "Plantão Operacional 24h", phone: "5549999999999", icon: "safe", message: "Olá! Preciso de suporte urgente com minha viagem." }
        ],
      },
      {
        id: "glow-exchange",
  ...
  },
  {
    ...
    description: "Ideal para consultores autônomos, focado em agendamentos de reuniões e Área do Passageiro.",
    category: "biolink",
    blocks: [
      {
        id: "clean-pro-hdr",
      ...
      },
      {
        ...
        description: "Acesse seus vouchers de embarque, passagens e assine seus contratos pendentes.",
  ...
  },
  {
    ...
    description: "Página de conversão focada em campanhas promocionais, com cronômetro de escassez.",
    category: "site",
    blocks: [
      {
        id: "promo-hero",
        ...
        subtitle: "Garanta seu lugar no nosso grupo confirmado com condições incríveis de pagamento.",
        bg_image_url: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        description: "Assine digitalmente seus termos e aditivos contratuais pendentes de assinatura.",
      },
      {
        id: "corp-support",
        type: "support_ticket_form",
        title: "Suporte & Solicitação de Viagem",
        subtitle: "Preencha a RFP ou abra um ticket de atendimento e responderemos em até 15 minutos.",
      },
      {
        id: "corp-map",
        type: "map",
  ...
  },
  {
    ...
    description: "Ideal para promover saídas de ecoturismo e aventura com cronograma e previsão do tempo.",
    category: "site",
    blocks: [
      {
        id: "adv-hero",
      ...
      },
      {
        ...
        layout: "cards",
        items: [
          { icon: "nature", title: "Contato com a Natureza", description: "Destinos preservados e experiências genuínas ao ar livre." },
          { icon: "safe", title: "Aventura Segura", description: "Seguro viagem premium e guias certificados inclusos." },
          { icon: "vip", title: "Grupos Reduzidos", description: "Turmas pequenas para maior segurança e aproveitamento." }
        ]
      },
      {
        id: "adv-carousel",
      ...
      },
      {
        ...
        layout: "bubble",
        items: [
          { author: "Bruno G.", role: "Trilha da Patagônia", text: "Excelente organização. O suporte foi essencial nas trilhas mais difíceis. Indico a todos!", avatar_url: "", stars: 5 }
        ]
      },
      {
        id: "adv-contact",
  ...
  },
  {
    ...
    description: "Portal corporativo avançado B2B focado em RFPs, assinaturas de contratos e suporte rápido.",
    category: "site",
    blocks: [
      {
        id: "lux-corp-hero",
        ...
        subtitle: "Tecnologia e atendimento exclusivo para otimizar os deslocamentos da sua empresa.",
        bg_image_url: "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1200&q=80",
        cta_label: "Falar com Consultor B2B",
        cta_link: "https://wa.me/5549999999999",
        layout: "split"
      ...
      },
      {
        ...
        description: "Assine digitalmente seus acordos corporativos com validade jurídica instantânea."
      },
      {
        id: "lux-corp-portal",
        type: "client_portal_access",
  ...
  },
  {
    ...
    description: "Layout abrangente para agências físicas completas com equipe, cupons e facilidades de pagamento.",
    category: "site",
    blocks: [
      {
        id: "fs-hero",
        ...
        subtitle: "Lazer, corporativo, intercâmbio e cruzeiros. Cuidamos de tudo para você só se preocupar em viajar.",
        bg_image_url: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    description: "Layout de link-in-bio focado no perfil individual do agente de viagem com redes sociais e canais.",
    category: "biolink",
    blocks: [
      {
        id: "ab-header",
      ...
      },
      {
        ...
        departments: [
          { name: "Orçamentos Personalizados", phone: "5549999999999", icon: "chat", message: "Olá! Gostaria de um orçamento." },
          { name: "Suporte 24h (Passageiros)", phone: "5549999999999", icon: "safe", message: "Olá! Preciso de suporte em viagem." }
        ]
      },
      {
        id: "ab-links",
        ...
        items: [
          ...
          { title: "Acessar Portal do Passageiro", url: "/auth/login", icon: "Web", highlight: false }
        ]
      }
    ]
  },
  {
    ...
    description: "Template de biolink para campanhas rápidas do Instagram com cronômetro de escassez e cupons.",
    category: "biolink",
    blocks: [
      {
        id: "lb-header",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Falar com Guia no WhatsApp", url: "https://wa.me/5549999999999", icon: "Chat", highlight: false }
        ]
      },
      {
        id: "lb-news",
  ...
  },
  {
    ...
    description: "Focado em passageiros em trânsito. Acesso rápido a vouchers, contratos e suporte 24h.",
    category: "biolink",
    blocks: [
      {
        id: "sb-header",
        type: "biolink_header",
        avatar_url: "https://images.unsplash.com/photo-1534536281715-e28d76689b4d?auto=format&fit=crop&w=150&q=80",
      ...
      },
      {
        ...
        departments: [
          { name: "Plantão Operacional 24h", phone: "5549999999999", icon: "safe", message: "Olá! Estou em viagem e preciso de suporte." },
          { name: "Setor de Emissões & Vouchers", phone: "5549999999999", icon: "key", message: "Olá! Gostaria de falar sobre meus vouchers." }
        ]
      },
      {
        id: "sb-upload",
  ...
  },
  {
    ...
    description: "Ideal para promover ecoturismo, safáris e turismo ecológico com formulários, avaliações e clima.",
    category: "site",
    blocks: [
      {
        id: "eco-hero",
        ...
        subtitle: "Explore a natureza intocada com guias qualificados e acomodação ecológica premium.",
        bg_image_url: "https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1200&q=80",
      ...
      },
      {
        ...
        layout: "cards",
        items: [
          { icon: "nature", title: "Turismo 100% Ecológico", description: "Preservação da vida selvagem e suporte a comunidades locais." },
          { icon: "vip", title: "Lodges Exclusivos", description: "Acomodações integradas à natureza com conforto absoluto." }
        ]
      },
      {
        id: "eco-carousel",
      ...
      },
      {
        ...
        subtitle: "Selecione suas preferências e nossos especialistas desenharão sua viagem sob medida."
      },
      {
        id: "eco-feedback",
  ...
  },
  {
    ...
    description: "Template dinâmico focado em vendas rápidas de pacotes turísticos com câmbio e contadores.",
    category: "site",
    blocks: [
      {
        id: "promo-fest-hero",
        ...
        subtitle: "Os destinos mais desejados do mundo com tarifas aéreas promocionais imperdíveis.",
        bg_image_url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    description: "Biolink focado no consultor de viagens, com dados de perfil, QR Code e WhatsApp flutuante.",
    category: "biolink",
    blocks: [
      {
        id: "ag-card-hdr",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Visitar Nosso Instagram @marianacostatravel", url: "https://instagram.com", icon: "Insta", highlight: false }
        ]
      },
      {
        id: "ag-card-share",
  ...
  },
  {
    ...
    description: "Canal mobile de autoatendimento para passageiros com verificação de vistos, status de voos e upload de documentos.",
    category: "biolink",
    blocks: [
      {
        id: "assist-hdr",
