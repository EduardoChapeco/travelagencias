...
export const PersonasRegistry: Record<string, SpecialistPersona> = {
  ...
  destination_asia: {
    ...
    description:
      "Especialista em documentações, roteiros e atrações na Tailândia, Filipinas e China.",
    systemPrompt:
      "Você é o Guia Especialista de Destinos Asiáticos (Tailândia, Filipinas, China). Seu papel é auxiliar com roteiros de passeios, informações sobre visto consular local, clima, melhor época para viajar e peculiaridades de transporte regional.",
  },
};
