...
function Page() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-3xl px-4 py-8 md:py-12" id="contract-document">
      ...
      {signed ? (
        <div
          className="overflow-hidden rounded-xl bg-success-bg  ring-1 ring-success/30"
        ...
        >
          <div className="flex flex-col items-center justify-center p-8 text-center">
            ...
            <p className="mt-2 text-sm text-success/80">
              O contrato foi chancelado criptograficamente em{" "}
          ...
          <div className="p-5 space-y-5">
              ...
              {selfie ? (
                <div className="relative inline-block">
                  <img
                    ...
                    className="h-32 w-32 rounded-full border-4 border-surface  object-cover"
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-col items-start gap-3">
                  <div className="text-xs text-muted-foreground">
                    Para garantir a autenticidade, precisamos de uma foto do seu rosto no momento da
                    assinatura.
                  </div>
                  <GhostButton
                    type="button"
                    onClick={takeSelfie}
                    className="rounded-full border-border/50 bg-surface "
                  >
            ...
            <div className="border-t border-border/50 pt-5 mt-5">
              ...
              <p className="mt-3 text-center text-[10px] text-muted-foreground">
                ...
                digital, atrelada ao seu IP, Dispositivo e biometria facial, nos termos da MP
                2.200-2/2001.
              </p>
            </div>
          </div>
