...
export const Route = createFileRoute("/m/contract/$token")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Assine seu contrato" },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-6">
      <div className="w-full max-w-md rounded-lg border border-border bg-surface p-8">
        <h1 className="text-xl font-semibold tracking-tight">Contrato</h1>
        <p className="mt-2 text-sm text-muted-foreground">Assine seu contrato</p>
