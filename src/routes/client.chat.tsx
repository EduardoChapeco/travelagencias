...
function ClientChatRoute() {
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-50 border border-border rounded-[var(--radius-card)] overflow-hidden mt-4 shadow-sm">
        {/* HEADER */}
              ...
              if (event.type === "ticket") {
                return (
                  <div key={`ticket-${event.id}`} className="flex justify-center my-4">
                    <div className="bg-zinc-100 border border-zinc-200 rounded-[var(--radius-card)] p-3 flex flex-col items-center max-w-sm text-center shadow-sm">
              ...
              if (event.type === "kyc") {
                return (
                  <div key={`kyc-${event.id}`} className="flex justify-center my-4">
                    <div className="bg-green-50 border border-green-200 rounded-[var(--radius-card)] p-3 flex flex-col items-center max-w-sm text-center shadow-sm">
              ...
              if (event.type === "proposal") {
                ...
                return (
                  <div key={`prop-${event.id}`} className="flex justify-center my-4">
                    <div className={`border rounded-[var(--radius-card)] p-3 flex flex-col items-center max-w-sm text-center shadow-sm ${isAccepted ? 'bg-blue-50 border-blue-200' : 'bg-white border-zinc-200'}`}>
