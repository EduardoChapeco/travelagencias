...
function MobileCheckinPage() {
  ...
  useEffect(() => {
    (supabase as any)
      .rpc("get_public_boarding_card", { p_id: token })
      ...
      <div className="bg-brand text-brand-foreground px-6 py-8 rounded-b-[2.5rem] relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-brand-foreground/80 font-medium text-sm">
            Acompanhe e confirme os passos para o seu voo.
          </p>
        </div>
      </div>
              ...
              <div className="divide-y divide-border/40">
                {checklist.map((it, i) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-sm font-medium ${it.done ? "line-through text-muted-foreground" : "text-foreground"}`}
                    >
                      {it.label}
                    </span>
                  </button>
