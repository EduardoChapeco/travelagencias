      ...
      <header className="bg-surface border-b border-border py-6 px-4 shrink-0 shadow-sm">
        <div className="max-w-xl mx-auto flex items-center gap-4">
          {lead.agency_logo ? (
            ...
            <div className="h-12 w-12 rounded-xl bg-brand/10 border border-brand/20 flex items-center justify-center font-bold text-brand text-lg">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-surface border border-border rounded-2xl p-5 space-y-4 shadow-sm">
              ...
              <div className="text-[11px] bg-brand/5 border border-brand/10 p-3.5 rounded-xl text-muted-foreground space-y-1">
            ...
            <div className="bg-surface border border-border rounded-2xl p-5 space-y-4 shadow-sm">
              ...
              {paxFormOpen && (
                <div className="border border-border/80 p-4 rounded-xl bg-surface-alt/10 space-y-3 mt-3">
