...
export const Route = createFileRoute("/p/$agency_slug/tour/$id")({
  head: () => ({
    meta: [
      { title: "Roteiro · TravelOS" },
      { name: "description", content: "Roteiro em grupo" },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-6">
      <div className="w-full max-w-md rounded-lg border border-border bg-surface p-8">
        <h1 className="text-xl font-semibold tracking-tight">Roteiro</h1>
        <p className="mt-2 text-sm text-muted-foreground">Roteiro em grupo</p>
