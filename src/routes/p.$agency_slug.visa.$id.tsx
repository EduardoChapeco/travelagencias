...
export const Route = createFileRoute("/p/$agency_slug/visa/$id")({
  head: () => ({
    meta: [
      { title: "Solicitação de Visto · TravelOS" },
      { name: "description", content: "Formulário público" },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-6">
      <div className="w-full max-w-md rounded-lg border border-border bg-surface p-8">
        <h1 className="text-xl font-semibold tracking-tight">Solicitação de Visto</h1>
        <p className="mt-2 text-sm text-muted-foreground">Formulário público</p>
