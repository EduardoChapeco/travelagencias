      ...
      <div className="mx-auto max-w-md p-10 text-center bg-surface border border-border/50 rounded-2xl  mt-10">
        ...
        <div className="mt-6 bg-surface-alt/50 border border-border/50 p-4 rounded-xl">
          ...
          <div className="font-mono text-lg font-bold text-foreground mt-1 select-all">
            {doneLeadId.split("-")[0].toUpperCase()}
          </div>
        </div>
        ...
        <div className="mt-8 space-y-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-success px-4 text-sm font-bold text-white  hover:bg-success/90 transition-colors"
          >
