...
export const Route = createFileRoute("/m/payment/$token")({
  head: () => ({
    meta: [
      { title: "Pagamento · TravelOS" },
      { name: "description", content: "Realize seu pagamento" },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-6">
      <div className="w-full max-w-md rounded-lg border border-border bg-surface p-8">
        <h1 className="text-xl font-semibold tracking-tight">Pagamento</h1>
        <p className="mt-2 text-sm text-muted-foreground">Realize seu pagamento</p>
