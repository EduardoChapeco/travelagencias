...
function Page() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-xl px-4 py-10">
      ...
      {done ? (
        <div className="rounded-[var(--radius-card)] border border-success bg-success-bg p-6 text-center text-sm text-success">
          ✓ Dados enviados com sucesso. Pode fechar esta página.
        </div>
      ) : (
        <form
          onSubmit={submit}
          className="space-y-3 rounded-[var(--radius-card)] border-none glass-card border-none p-5"
        >
          ...
          <div
            ...
            className={`flex items-start gap-2.5 rounded-[var(--radius-card)] border p-4 transition-all ${
              lgpdError
