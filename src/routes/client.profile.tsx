  ...
  return (
    <>
      ...
      <form
        ...
        className="max-w-2xl space-y-6 rounded-[var(--radius-card)] border-none glass-card border-none p-6"
      >
        ...
        {!me.data?.client && (
          <div className="rounded-full border-none bg-warning-bg p-3 text-xs text-foreground">
